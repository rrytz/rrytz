...
export default function Stack() {
  ...
  const techLogos = [
    ...
    { node: <SiPostgresql size={28} />, title: "PostgreSQL", href: "https://www.postgresql.org" },
    { node: <SiSupabase size={28} />, title: "Supabase", href: "https://supabase.com" },
    { node: <SiPython size={28} />, title: "Python", href: "https://www.python.org" },
    { node: <SiGit size={28} />, title: "Git", href: "https://git-scm.com" },
    { node: <SiDocker size={28} />, title: "Docker", href: "https://www.docker.com" },
    { node: <SiFigma size={28} />, title: "Figma", href: "https://www.figma.com" },
  ];
